...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] != true) {
  ...
  header( "refresh:2;url=" . __DIR__ . "/pineappleaccesscontrol/login.php" );
  echo 'You must log in to view this page, You will now be redirected automatically, or, click <a href="' . __DIR__ . '/pineappleaccesscontrol/login.php">here</a>.';
  exit();
} else {
  $pac = "yes"; //Displays log out button
}
?>